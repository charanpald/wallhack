...
"""
We look at the ROC curves for the different itemExps 
"""
...
if saveResults: 
    ...
    for itemExpP in itemExpPs: 
        for trainX, testX in trainTestXs: 
            learner = maxLocalAuc.copy()
            learner.itemExpP = itemExpP 
            paramList.append((trainX, testX, learner, U, V))

    for itemExpQ in itemExpQs: 
        for trainX, testX in trainTestXs: 
            learner = maxLocalAuc.copy()
            learner.itemExpQ = itemExpQ 
            paramList.append((trainX, testX, learner, U, V))
