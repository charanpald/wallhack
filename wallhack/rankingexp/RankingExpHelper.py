...
class RankingExpHelper(object):
    ...
    defaultAlgoArgs.k = 64
    defaultAlgoArgs.ks = 2**numpy.arange(5, 8)
    ...
    defaultAlgoArgs.lmbdaItems = 2.0**-numpy.arange(2, 10, 2)
    ...
    defaultAlgoArgs.alphas = 2.0**numpy.arange(5, 11)
